...
/* ============================================================
   HELPERS
   ============================================================ */
const PH_BIZ = "/images/map.png";

/* ============================================================
   DINING CARD COMPONENT (local — links to /places/${slug})
   ============================================================ */
function DiningCard({
  biz,
...
/* ============================================================
   DINING CLIENT COMPONENT
   ============================================================ */
export function EatsAndDrinksClient({
  areas,
  neighborhoods,
  categories,
  tags,
  ...
  return (
    <>
      ...
      {/* ========== 4. FEATURED RESTAURANTS (Premium only) ========== */}
        ...
        <section className="site-container pb-12">
          <div className="flex items-end justify-between border-b border-gray-200 pb-4 mb-8">
            ...
            <span className="text-xs text-gray-mid pb-1">
              {featuredBusinesses.length} restaurant
              {featuredBusinesses.length !== 1 ? "s" : ""}
            </span>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {featuredBusinesses.map((biz) => (
              <DiningCard key={biz.id} biz={biz} showPremiumBadge />
            ))}
          </div>
        </section>
      )}

      {/* ========== 5. GET YOUR RESTAURANT FEATURED CTA ========== */}
      ...
      <section className="site-container pb-12">
        ...
        >
          <MapIcon size={16} />
          {showMap ? "Hide Dining Map" : "Show Dining Map"}
        ...
        <div className={`${showMap ? "block" : "hidden"} lg:block`}>
          <div className="relative w-full h-[280px] lg:h-[400px] bg-gray-200 overflow-hidden">
            <Image
              src="/images/map.png"
              alt="Atlanta Dining Map — placeholder"
              fill
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-9 lg:gap-16">
          ...
          <div>
            <div className="flex items-end justify-between border-b border-gray-200 pb-4 mb-8">
              ...
              <span className="text-xs text-gray-mid pb-1">
                {totalGridCount} restaurant{totalGridCount !== 1 ? "s" : ""}
              </span>
            </div>
            ...
            {gridBusinesses.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-mid text-xs">
                  Know a great Atlanta restaurant?{" "}
                  <Link
                    href="/submit"
      ...
      <section className="bg-black py-16 mt-12">
        <div className="site-container text-center">
          ...
          <p className="text-white/60 text-sm max-w-[420px] mx-auto mb-8 leading-relaxed">
            Get weekly restaurant spotlights, dining deals, and community
