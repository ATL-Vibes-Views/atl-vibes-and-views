      ...
      <section className="relative h-[45vh] sm:h-[55vh] md:h-[80vh] min-h-[340px] max-h-[640px] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-[900px] px-5">
          ...
          <Link
            ...
            className="inline-block bg-[#fee198] text-[#1a1a1a] rounded-full font-semibold text-[15px] tracking-[0.5px] px-9 py-4 hover:bg-[#c1121f] hover:text-white transition-all"
          >
            Let&rsquo;s Talk
          </Link>
        </div>
        ...
        <main className="min-w-0">
          ...
          <section className="bg-white">
            ...
            <div className="text-center py-16 px-5">
              <Link
                href="/partner/contact"
                className="inline-block bg-[#fee198] text-[#1a1a1a] rounded-full font-semibold text-lg tracking-[0.5px] px-12 py-5 hover:bg-[#c1121f] hover:text-white transition-all"
              >
          ...
          <section className="relative py-24 md:py-32 text-center overflow-hidden">
            ...
            <div className="relative z-10 site-container">
              ...
              <Link
                href="/partner/contact"
                className="inline-block bg-[#fee198] text-[#1a1a1a] rounded-full font-semibold text-[15px] tracking-[0.5px] px-9 py-4 hover:bg-white transition-all"
              >
                Get Started
              </Link>
            </div>
