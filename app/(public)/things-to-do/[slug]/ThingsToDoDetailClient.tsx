...
/* =============================================================
   QUICK INFO STRIP
   Rating summary + Save / Share (NO Claim Listing, NO Write Review)
   ============================================================= */
...
/* =============================================================
   MORE THINGS TO DO SCROLLER with arrows
   ============================================================= */
export function MoreThingsToDoScroller({
  places,
  neighborhoodName,
  neighborhoodSlug,
}: {
