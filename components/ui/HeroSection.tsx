      ...
      <section className={`relative w-full ${effectiveType === "post" ? "cursor-pointer group" : ""} ${className}`}>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          {effectiveType === "post" && heroPost ? (
            <>
              {heroPost.category && (
                <span className="inline-block bg-[#fee198] text-[#1a1a1a] text-[11px] font-semibold uppercase tracking-[0.12em] px-3 py-1 mb-4 rounded-full">
                  {heroPost.category}
                </span>
              )}
        ...
        <div className="grid grid-cols-2 min-h-[480px]">
          ...
          <div className="flex flex-col justify-center px-16">
            {effectiveType === "post" && heroPost ? (
              <>
                {heroPost.category && (
                  <span className="inline-block bg-[#fee198] text-[#1a1a1a] text-[11px] font-semibold uppercase tracking-[0.12em] px-3 py-1 mb-4 rounded-full self-start">
                    {heroPost.category}
                  </span>
                )}
